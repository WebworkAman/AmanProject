...
@section('content')
    ...
    <div class="formgroup installation_type">
        ...
        <ul>
            <li>
                <span>公司名稱 ：</span><p>{{$crmMachine->installation_company_name}}</p>
            ...
            <ol>
               <li><span>國家</span><p>{{$crmMachine->installation_company_country}}</p></li>
               <li><span>郵遞區號</span><p>{{$crmMachine->installation_company_postal_code}}</p></li>
               <li><span>區域</span><p>{{$crmMachine->installation_company_region}}</p></li>
            </ol>
            <ol>
               <li><span>城市</span><p>{{$crmMachine->installation_company_city}}</p></li>
               <li><span>街/路名</span><p>{{$crmMachine->installation_company_street}}</p></li>
            </ol>

                
           
            <li><span>統一編號 ：</span><p>{{$crmMachine->installation_vat_number}}</p></li>
            ...
            <li><span id="installation_company_phone">公司電話 ：</span></li>
                <ol>
                   ...
                   @if(!empty($phone['country_code_1']) || !empty($phone['area_code_1']) || !empty($phone['phone_number_1']))
                     <li><span>國碼</span><p>{{ $phone['country_code_1'] ?? '' }}</p></li>
                     <li><span>區碼</span><p>{{ $phone['area_code_1'] ?? '' }}</p></li>
                     <li><span>電話號碼</span><p>{{ $phone['phone_number_1'] ?? '' }}</p></li>
                    @endif
                    
                </ol>
                <ol>
                   @if(!empty($phone['country_code_2']) || !empty($phone['area_code_2']) || !empty($phone['phone_number_2']))
                     <li><span>國碼</span><p>{{ $phone['country_code_2'] ?? '' }}</p></li>
                     <li><span>區碼</span><p>{{ $phone['area_code_2'] ?? '' }}</li>
                     <li><span>電話號碼</span><p>{{ $phone['phone_number_2'] ?? '' }}</p></li>
                    @endif
                </ol>
                <ol>
                    @if(!empty($phone['country_code_3']) || !empty($phone['area_code_3']) || !empty($phone['phone_number_3']))
                     <li><span>國碼</span><p>{{ $phone['country_code_3'] ?? '' }}</p></li>
                     <li><span>區碼</span><p>{{ $phone['area_code_3'] ?? '' }}</p></li>
                     <li><span>電話號碼</span><p>{{ $phone['phone_number_3'] ?? '' }}</p></li>
                     @endif
                </ol>
                @endforeach
            @endif                
            <li>
                  ...
                  <li><span id="installation_company_fax">公司傳真 ：</span></li>
                     @if ($companyFax)
                        <ol>
                          <li><span>國碼</span><p>{{ $companyFax->country_code }}</p></li>
                          <li><span>區碼</span><p>{{ $companyFax->area_code }}</p></li>
                          <li><span>電話號碼</span><p>{{ $companyFax->fax_number }}</p></li>
                       </ol>
                     @endif
                  </li>
        </ul>
