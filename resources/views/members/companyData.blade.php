...
@section('content')
 ...
 <main>
   ...
   @endphp
    ...
    <div id="companyDataView" class="CompanyData-nav companyData" @if(session('editMode')) style="display:none;" @else style="display:block;" @endif>
   ...
   <!-- 公司基本資料 -->
    ...
    <div id="companyDataEdit" class="companyDataEdit" @if(session('editMode')) style="display:block;" @else style="display:none;" @endif>
      ...
      <form method="post" action="{{ route('companyUpdate', ['companyId' => $companyId]) }}">
            ...
            <div class="formgroup">
                ...
                <ul>
                    <li>
                        <span>國家(*)</span> <input type="text" name="company_address[country]" id="country" value="{{ old('company_address.country', $company_address->country??'') }}">
                    ...
                    <li>
                        <span>區域(*)</span><input type="text" name="company_address[region]" id="region" value="{{ old('company_address.region',$company_address->region ?? '') }}">
                        @error('company_address.region')
                          <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </li>
                    <li>
                        <span>城市(*)</span><input type="text" name="company_address[city]" id="city" value="{{ old('company_address.city',$company_address->city ?? '') }}">
                        @error('company_address.city')
                          <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </li>
                    <li>
                        <span>街/路名(*)</span><input type="text" name="company_address[street]" id="street" value="{{ old('company_address.street',$company_address->street ?? '') }}">
