        ...
        <div id="companyDataEdit" class="companyDataEdit">
            ...
            <form method="post" action="{{ route('companyCreate', ['companyId' => $companyId]) }}">
                ...
                @if ($years > 5)
                    ...
                    <div class="formgroup">
                        ...
                        {{-- <ul>
                            <li>
                                <span>國家</span> <input type="text" name="company_address[country]" id="country"
                                    value="{{ old('company_address.country', $company_address->country ?? '') }}" required>
                            ...
                            <li><span>區域</span><input type="text" name="company_address[region]" id="region"
                                    value="{{ $company_address->region ?? '' }}"></li>
                            <li><span>城市</span><input type="text" name="company_address[city]" id="city"
                                    value="{{ $company_address->city ?? '' }}"></li>
                            <li><span>街/路名</span><input type="text" name="company_address[street]" id="street"
                                    value="{{ $company_address->street ?? '' }}"></li>
                        </ul> --}}
                        ...
                        <ul>
                            ...
                            <li>
                                <span>郵遞區號</span><input type="text" name="company_address[postal_code]" id="postal_code"
                                    value="{{ $postalCode ?? '' }}">
                            </li>
                            <li>
                                <span>區域*</span><input type="text" name="company_address[region]" id="region"
                                    value="{{ $company_address->region ?? '' }}">
                    ...
                    <div class="formgroup phone_type">
                        ...
                        <ul>
                            <li><span>國碼</span><input type="text" name="company_phone[country_code_1]"
                                    id="country_code_1" value="{{ $companyPhones[0]['country_code_1'] ?? '' }}"></li>
                            ...
                            <li><span>電話號碼</span><input type="text" name="company_phone[phone_number_1]"
                                    id="phone_number_1" value="{{ $companyPhones[0]['phone_number_1'] ?? '' }}"></li>
                        </ul>
                        <ul>
                            <li><span>國碼</span><input type="text" name="company_phone[country_code_2]"
                                    id="country_code_2" value="{{ $companyPhones[1]['country_code_2'] ?? '' }}"></li>
                        ...
                        <ul>
                            <li><span>國碼</span><input type="text" name="company_phone[country_code_3]"
                                    id="country_code_3" value="{{ $companyPhones[2]['country_code_3'] ?? '' }}"></li>
                    ...
                    <div class="formgroup phone_type">
                        ...
                        <ul>
                            ...
                            <li><span>區碼</span><input type="text"
                                    name="company_purchase_person_phone[purchase_area_code]" id="purchase_area_code"
                                    value="{{ $companyPurchasePerson->area_code ?? '' }}"></li>
                        </ul>
                        <ul>
                            ...
                            <li><span>分機</span><input type="text"
                                    name="company_purchase_person_phone[purchase_extension]" id="purchase_extension"
                                    value="{{ $companyPurchasePerson->purchase_extension ?? '' }}"></li>
                        </ul>
                    </div>
                ...
                @else
                    ...
                    <p style="color:rgb(63, 75, 75);font-size:1.2rem;">原地址：{{ $tbm01->ba05 ?? '' }}</p>
                    ...
                    <div class="formgroup">
                        ...
                        <ul>
                            ...
                            <li>
                                <span>郵遞區號</span><input type="text" name="company_address[postal_code]"
