                ...
                <form method="post" action="{{ route('companyMachineAddPost') }}">
                    ...
                    <div id="machineData" style="display: block;">
                        ...
                        <div class="formgroup installation_type">
                            ...
                            <ul>
                                ...
                                <ol>
                                    ...
                                    <li><span>區碼</span><input type="text" name="installation_company_phone[area_code_1]"
                                ...
                                <ol>
                                    ...
                                    <li><span>區碼</span><input type="text" name="installation_company_phone[area_code_2]"
                                ...
                                <ol>
                                    ...
                                    <li><span>區碼</span><input type="text" name="installation_company_phone[area_code_3]"
                                ...
                                <ol>
                                    ...
                                    <li><span>國碼</span><input type="text" name="installation_company_fax[country_code]"
                                            id="installation_fax_country_code"></li>
                                    <li><span>區碼</span><input type="text" name="installation_company_fax[area_code]"
                                            id="installation_fax_area_code"></li>
                                    <li><span>電話號碼</span><input type="text" name="installation_company_fax[fax_number]"
                                            id="installation_fax_number"></li>
                                </ol>
                                </li>
                            </ul>
                        ...
                        <div class="other_purchase_source_block" style="display:none;">
                            ...
                            <div class="formgroup subBlock">
                                <span>公司名稱</span><input type="text" name="other_purchase_company_name"
                            ...
                            <div class="formgroup phone_type subBlock">
                                <ul>
                                    <li><span>國家</span><input type="text"
                                            name="other_purchase_company_address[country]" id="other_purchase_country">
                                    </li>
                                    <li><span>郵遞區號</span><input type="text"
                                            name="other_purchase_company_address[postal_code]"
                                            id="other_purchase_postal_code"></li>
                                    <li><span>區域</span><input type="text" name="other_purchase_company_address[region]"
                                            id="other_purchase_region"></li>
                                </ul>
                                <ul>
                                    <li><span>城市</span><input type="text" name="other_purchase_company_address[city]"
                                            id="other_purchase_city"></li>
                                    <li><span>街/路名</span><input type="text"
                                            name="other_purchase_company_address[street]" id="other_purchase_street"></li>
                                </ul>
                            </div>
                            <div class="formgroup subBlock">
                                <span>統一編號 </span><input type="text" name="other_purchase_tax_id"
