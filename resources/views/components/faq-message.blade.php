            ...
            <ul>
                <li class="faq-item">
                    ...
                    <div class="faq-content">
                        ...
                        <div class="faq-photo">
                            @if ($faq->photo)
                                <button id="showFAQPhotoBtn" class="showPhotoBtn"
                                    data-photo-url="{{ Storage::url($faq->photo) }}">
                                    檢視照片
                                </button>
                        ...
                        <div class="faq-video">
                            @if ($faq->video)
                                <button id="showFAQPhotoBtn" class="showVideoBtn"
                                    data-video-url="{{ Storage::url($faq->video) }}">
                                    檢視影片
                                </button>
